...
export function CTASection() {
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-background-primary via-surface-card to-background-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[28px] border border-pink-300/20 bg-gradient-to-b from-[#0d0d10] to-[#121218] p-8 md:p-14 shadow-[0_24px_70px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative text-center space-y-9">
            <div className="space-y-5">
              ...
              <p className="text-text-secondary/90 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="rounded-full border border-pink-200/30 bg-gradient-to-r from-pink-300 to-pink-200 text-background-primary font-semibold px-8 py-3 transition-all duration-300 hover:-translate-y-[1px] hover:from-pink-200 hover:to-pink-100 hover:shadow-[0_10px_30px_rgba(244,175,196,0.28)]"
              >
                Começar a explorar
              </Link>
              <Link
