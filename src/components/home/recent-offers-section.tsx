  ...
  return (
    <section id="ofertas-recentes" className="py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-10 max-w-3xl space-y-5 text-center md:mb-12">
          ...
          <p className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[0.03] px-4 py-2 text-sm text-white/75">
        ...
        {products.length > 0 ? (
          ...
          <div className="rounded-2xl border border-border-soft bg-surface-card/75 p-10 text-center">
            <p className="text-lg font-semibold text-text-primary">Nenhum achadinho disponível no momento</p>
            <p className="mt-2 text-text-secondary/90">Adicione produtos no Supabase para exibir aqui.</p>
          </div>
        )}
      </div>
    </section>
